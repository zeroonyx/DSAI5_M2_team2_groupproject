...
st.title("Olist Customer and Order Fulfillment Analysis")
st.markdown("""
This interactive dashboard analyzes customer profile, logistics fulfillment, delivery delay metrics, 
